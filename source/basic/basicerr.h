...
typedef enum basic_err {
    ...
    BASIC_ERR_UNBOUND_LOCAL_VAR = 35,
    BASIC_ERR_ARG_COUNT_MISMATCH = 36,
    BASIC_ERR_INVALID_ARG_VALUE = 37,
    BASIC_ERR_EXPECTED_IDENTIFIER = 38,
    BASIC_ERR_UNMATCHED_NEXT = 39,
    BASIC_ERR_EXPECTED_DASH = 40,
    BASIC_ERR_NO_GOSUB = 41,
    BASIC_ERR_INVALID_LINE_NUMBER = 42,
} basic_err_t ;